...
int inference_zipformer_model_streaming(rknn_zipformer_context_t *app_ctx, knf::OnlineFbank *fbank, VocabEntry *vocab, std::vector<std::string> &recognized_text,
                                       std::vector<float> &timestamp, int &frame_offset);
